      ...
      <div class="d-flex ai-center fw-wrap gs16 mb16">
        <a class="flex--item" href="/users/2930622/g-rafael">
          <div class="md:d-none js-usermini-avatar-container">
            <div class="bar-md bs-sm" >
              <img
                src="https://cdn.vox-cdn.com/thumbor/YcVLI8UM9mTyIlDQkodM8dPZ6A4=/0x86:706x557/1220x813/filters:focal(0x86:706x557):format(webp)/cdn.vox-cdn.com/assets/738480/stevejobs.png"
                alt="user avatar"
        ...
        <div class="flex--item">
          <div class="d-flex ai-center fw-wrap gs8 wmx4">
            <div class="flex--item mb12 fs-headline2 lh-xs">Steve Jobs</div>
            <div class="flex--item">
          ...
          <ul class="list-reset s-anchors s-anchors__inherit d-flex fc-light gs8 mln4 fw-wrap">
            ...
            <li class="flex--item">
              <div class="d-flex gs4 gsx ai-center">
                ...
                <div class="flex--item">Last seen this month </div>
              </div>
            </li>
          </ul>
        </div>
